...
def search():
  ...
  flower_feature_list = return_all_flower_features([size_dictionary, colour_dictionary, smell_dictionary, season_dictionary, latin_dictionary, maintenance_dictionary],flower_being_searched_for)
  ...
  FLOWER_NAME = form_data["flower"],
  FLOWER_SIZE = flower_feature_list[0], 
  FLOWER_COLOUR = flower_feature_list[1],
  FLOWER_SMELL = flower_feature_list[2],
  FLOWER_SEASON = flower_feature_list[3],
  FLOWER_LATIN_NAME = flower_feature_list[4]
  )
